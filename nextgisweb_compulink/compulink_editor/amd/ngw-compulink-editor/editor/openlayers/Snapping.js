/* Based on
 * https://github.com/openlayers/openlayers/blob/a34e627b755be5abc154d0deaf15c106def7801b/lib/OpenLayers/Control/Snapping.js
 */

define([
    'ngw/openlayers'
], function (openlayers) {
    if (openlayers.Control.EditorSnapping) {
        return openlayers.Control.EditorSnapping;
    }
     ...
     *  - <OpenLayers.Control>
     */
    openlayers.Control.EditorSnapping = openlayers.Class(openlayers.Control, {
        ...
        CLASS_NAME: "OpenLayers.Control.EditorSnapping"
    });
